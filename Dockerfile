...
RUN ["wget", "-O", "/tmp/nexus-2.7.0-bundle.tar.gz", "http://download.sonatype.com/nexus/oss/nexus-2.7.0-bundle.tar.gz"]
RUN tar -zxvf /tmp/nexus-2.7.0-bundle.tar.gz -C /opt/sonatype-nexus --strip-components=1
